...
create table Admin_User(
    idAdmin_User serial primary key,
    nom VARCHAR(255),
    prenom varchar(20),
    email varchar(20),
...
create table Poche_monaie(
    idPoche_monaie serial primary key,
    idUsers integer references Users(idUsers),
    montant float
);

insert into Users(nom,prenom,telephone,genre,email,photo,addresse,password)
values ('nom1','p2','1234455','F','emali@gmail.com','photo1','Lotg','1234');

insert into Users(nom,prenom,telephone,genre,email,addresse,mdp)
values ('nom1','p2','1234567','femme','nomsradnom@gmail.com','Lot','1234');
...
-- 
--  num | jour | nomactivites | duree | kalytype | kalynom | quantite | prix
-- -----+------+--------------+-------+----------+---------+----------+------
--    1 | J1   | trotine      |    15 | vegetale | katsaka |      500 | 2000
--    2 | J2   | foot soccer  |    10 | vegetale | riz     |      200 | 1000
...
values (3,20,78,1.80),(1,25,80,1.78);
...
create table Statistique(
    ...
    idUser_profil integer  
);

create table Transaction(
    idTransaction serial primary key,
    idUsers integer references Users(idUsers),
    idCode_credit integer references Code_credit(idCode_credit),
...
create table Code_credit(
    idCode_credit serial primary key,
    nombre varchar(50),
    montant float
);
--  num | userid | jour | user_poids | nomactivites | duree | kalytype |   kalynom    | quantite | prix
-- -----+--------+------+------------+--------------+-------+----------+--------------+----------+------
--    1 |      1 | J1   |         78 | trotine      |    15 | vegetale | katsaka      |      500 | 2000
--    2 |      2 | J2   |         80 | foot soccer  |    10 | vegetale | riz          |      200 | 1000
--    3 |      1 | J3   |         78 | foot soccer  |    10 | vegetale | riz          |      200 | 1000
--    4 |      1 | J4   |         78 | natation     |    20 | animal   | viande rouge |      500 | 5000
--    5 |      1 | J5   |         78 | foot soccer  |    10 | animal   | viande rouge |      500 | 5000
